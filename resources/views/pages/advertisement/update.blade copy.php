                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <select class="form-control select2 custom-select" data-placeholder="Choose one" name="adv_type">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <div class="form-row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" id="inputLifetimeImpression" name="lifetime_impression" class="form-control" min="1" value="{{ old('lifetime_impression', $lifetime_impression) }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <input type="number" id="inputBudget" name="budget" class="form-control" value="{{ old('budget', $budget) }}" min="1">
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <select class="form-control" name="country_id" id="adv_country">
                                ...
                                <div class="feedMediaSection">
                                    <div class="form-group" id="imageSectionFeed">
                                        ...
                                        <div class="form-row imgFeedBlock nativeAdBlock" id="nativeAd_{{ $key }}">
                                            ...
                                            <div class="col-md-2">
                                                <div class="controls">
                                                    <select class="form-control nativeAdType" name="native_ad_type[{{ $native['media_id'] }}]" id="native_ad_type{{ $key }}">
                                            ...
                                            <div class="col-md-2">
                                                <input type="number" id="inputAdvFeedShowTime{{ $key }}" name="nativeAdPercent[{{ $native['media_id'] }}]" placeholder="Enter time percent" class="form-control inputAdvFeedShowTime nativeAdPercent" min="1" value="{{ $native['time_percent'] }}"
                                                onkeyup="nativeAdPercentCalculation(this)">
                                            </div>
                                            <div class="col-md-2">
                                        ...
                                        <div class="form-row imgFeedBlock nativeAdBlock">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <div class="controls">
                                                    <select class="form-control nativeAdType" name="native_ad_type[]" id="native_ad_type">
                                                        <option value="">Select Type</option>
                                            ...
                                            {{-- <img class="img-preview" src=""  width="10%" height="auto"> --}}
                                        </div>
                                        @endif
                                    </div>
                                ...
                                <div class="storyMediaSection">
                                    ...
                                    @foreach($advertisement['Story'] as $key => $story)
                                        <div class="form-row  mt-2" id="storyBlock_{{ $key }}">
                                            ...
                                            <img src="{{ asset($story['media_link']) }}"  width="10%" height="auto">
                                        </div>
                                    @endforeach
                                    </div>
                                    <div class="addButton">
                                    ...
                                    <div class="form-group" id="imageSectionStory">
                                        <div class="form-row storyBlock">
                                                ...
                                                <div class="custom-file">
                                                    <div id="imageSection">
                                                        <input  type="file" class="custom-file-input story_ad_img"
                                                            id="story_ad_img" name="storyAdMedia[]" accept="video/*,image/*">
                                                        <label class="custom-file-label" for="story_ad_img">Choose file</label>
                                                    </div>
                                            ...
                                            <div class="col-md-4">
                                                <label for="">Reference Url</label>
                                                <input type="url" id="storyLinkId{{ $key }}" name="storyAdRefLink[]" placeholder="Enter Referal Link" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="addButton">
                            ...
                            <div id="bannerMediaParent">
                                ...
                                <div class="bannnerMediaSection">
                                    ...
                                    @foreach($advertisement['Banner'] as $key => $banner)
                                        <div class="form-row  mt-2" id="bannerBlock_{{ $key }}">
                                            <div class="col-md-3" style="padding-left: 20px;">
                                                <div class="custom-file">
                                                    <div id="imageSection">
                                                        <input
                                                            type="file" class="custom-file-input banner_ad_img"
                                                            id="banner_ad_img" name="bannerAdImg[{{ $banner['media_id'] }}]" accept="image/*">
                                            ...
                                            <div class="col-md-2">
                                                <div class="controls">
                                                    <select class="form-control bannerAdType" name="banner_ad_type[{{ $banner['media_id'] }}]" id="banner_ad_type">
                                                        <option value="">Select Type</option>
                                            ...
                                            <div class="col-md-2">
                                                <input type="url" id="inputAdvFeedLink" name="bannerAdRefLink[{{ $banner['media_id'] }}]" placeholder="Enter Referal Link" class="form-control" value="{{ $banner['referal_link'] }}">
                                            </div>
                                            <div class="col-md-2">
                                                <input type="number" id="bannerAdPercent0" name="bannerAdPercent[{{ $banner['media_id'] }}]" placeholder="Enter time percent" class="form-control bannerAdPercent" min="1" value="{{ $banner['time_percent'] }}">
                                            </div>
                                            <div class="col-md-2">
                                            ...
                                            <img src="{{ asset($banner['media_link']) }}"  width="10%" height="auto">
                                        </div>
                                    @endforeach
                                    </div>
                                    <div class="addButton">
                                    ...
                                    <div class="form-group" id="bannerSection">
                                        <div class="form-row bannerItems">
                                            <div class="col-md-3">
                                                ...
                                                <div class="custom-file">
                                                    <div id="imageSection">
                                                        <input
                                                            type="file" class="custom-file-input banner_ad_img"
                                                            id="banner_ad_img" name="bannerAdImg[]" accept="image/*">
                                                        <label class="custom-file-label" for="banner_ad_img">Choose file</label>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-1 pl-0 pr-0 text-center">
                                                <label class="control-label">Preview</label>
                                                <div>
                                                    <a href="javascript:void(0)" type="button" class="btn btn-outline-primary" id="previewBannerButton" onclick="fnPreviewBannerAd(1)"><i class="fe fe-smartphone"></i></a>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <label class="control-label">Ad Type</label>
                                            ...
                                            <div class="col-md-2">
                                                <label for="">Reference Url</label>
                                                <input type="url" id="inputAdvFeedLink" name="bannerAdRefLink[]" placeholder="Enter Referal Link" class="form-control" value="">
                                            </div>
                                            <div class="col-md-2">
                                                <label for="">Percent</label>
                                                <input type="number" id="bannerAdPercent0" name="bannerAdPercent[]" placeholder="Enter time percent" class="form-control nativePercent bannerAdPercent" min="1" value="100"
                                                onkeyup="bannerAdPercentCalculation(this)">
                                            </div>
                                            <div class="col-md-2">
                                                <label class="control-label">Position</label>
                                                <div class="controls">
                            ...
                            <div id="homeBannerParent">
                                ...
                                <div class="homeBannerSection">
                                    <div class="form-group" id="imageSectionHomeBanner">
                                        @if(isset($advertisement['homeBanner']))
                                        <div class="form-row" >
                                            <div class="col-md-8">
                                        ...
                                        @foreach($advertisement['homeBanner'] as $key => $banner)
                                        <div class="form-row homeBannerBlock mt-2" id="homeBannerBlock_{{ $key }}">
                                            <div class="col-md-8 margin-bottom-minus-10 mb-2" style="padding-left: 20px;">
                                                <div class="custom-file">
                                                    <div id="homeBannerImageSection">
                                                        <input  type="file" class="custom-file-input home_banner_img"
                                                            id="home_banner_img{{ $key }}" name="homeBannerMedia[{{ $banner['media_id'] }}]" accept="image/*">
