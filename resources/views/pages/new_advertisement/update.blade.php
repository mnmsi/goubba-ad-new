            ...
            <div class="wrapper">
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-2">
                        <div class="steps-area steps-area-fixed bg-step-color" style="position: static">
                            <div class="image-holder" style="height: 800px">
                                <img class="d-none" src="{{ asset('assets/form-wizard/img/luke-chesser-3rWagdKBF7U-unsplash.jpg') }}" alt="">
                            </div>
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-10 overflow-auto">
                        <form action="{{ route('adv.update', ['campaign_id' => $campaign_id]) }}" class="multisteps-form__form" id="wizard" method="POST" enctype="multipart/form-data">
                            @csrf
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-12 col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" id="brand_title" name="brand_title" placeholder="Enter Brand Name" class="form-control required"  value="{{ old('brand_title', $brand_title) }}" required>
                                                            ...
                                                            <div class="col-sm-12 col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="file" class="dropify form-control" data-height="185" accept="image/*" data-default-file="{{ asset($brand_logo) }}" id="brand_logo" name="brand_logo" />
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-12 col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="inputCampaignName" name="campaign_name" placeholder="Enter Campaign Name" class="form-control required"  value="{{ old('campaign_name', $campaign_name) }}">
                                                                ...
                                                                <select class="form-control select2 required" data-placeholder="Choose one" name="adv_campaign[]" data-placeholder="Choose one">
                                                                    ...
                                                                    @foreach($CampaignType as $CampaignType)
                                                                        <option
                                                                            ...
                                                                            {{ !empty(old('adv_campaign', $campaign_type_id)) ? ($CampaignType->campaign_type_id == (old('adv_campaign')[0] ?? $campaign_type_id) ? 'selected' : '') : ''}}
                                                                        >
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" id="inputDailyImpression" name="daily_impression" class="form-control required" min="1" value="{{ old('daily_impression', $daily_impression) }}">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input id="inputStartDate" name="start_date" class="form-control required" value="{{ old('start_date', $start_date) }}" placeholder="Please select start date">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="inputStartTime" name="start_time" class="form-control timepicker timeKeydown required" value="{{ old('start_time', $start_time) }}" placeholder="Please select start time" required>
                                                        ...
                                                        <div class="col-sm-12 col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="title" name="title" placeholder="Enter Advertisement Title" class="form-control required"  value="{{ old('title', $title) }}">
                                                                @if($errors->has('title'))
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="controls">
                                                                    <input type="number" id="inputBudget" name="budget" class="form-control number-input required" value="{{ old('budget', $budget) }}" min="1">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" id="inputLifetimeImpression" name="lifetime_impression" class="form-control number-input required" min="1" value="{{ old('lifetime_impression', $lifetime_impression) }}">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input id="inputEndDate" name="end_date" class="form-control required" value="{{ old('end_date', $end_date) }}" placeholder="Please select end date">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="inputEndTime" name="end_time" class="form-control  timepicker timeKeydown required" value="{{ old('end_time', $end_time) }}" placeholder="Please select start time">
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea class="form-control required" rows="2" name="desc" style="height: 63px">{{ old('desc', $desc) }}</textarea>
                                                                @if($errors->has('desc'))
                                                                ...
                                                                <select class="multi-select" id="advCity" name="city_id[]" multiple>
                                                                    @foreach($Cities as $Cities)
                                                                        <option value="{{ $Cities->id}}"
                                                                            {{ !empty(old('city_id')) || !empty(old($city_id)) ? (in_array($Cities->id, old('city_id', $city_id)) ? 'selected' : '') : 'selected'}}
                                                                            > {{ $Cities->name}}</option>
                                                                    @endforeach
                                                                </select>
                                                                ...
                                                                <select class="multi-select" id="advState" name="state_id[]" multiple>
                                                                    @foreach($States as $State)
                                                                        <option value="{{ $State->id}}"
                                                                            {{ !empty(old('state_id')) || !empty(old($state_id)) ? (in_array($State->id, old('state_id')) ? 'selected' : '') : 'selected'}}
                                                                            > {{ $State->name}}</option>
                                                                    @endforeach
                                                                </select>
                                                                ...
                                                                <select class="multi-select" id="favorite_store" name="favorite_store_ids[]" multiple>
                                                                    @foreach($favoriteStores as $store)
                                                                        <option value="{{ $store->id}}"
                                                                            {{ !empty(old('favorite_store_ids')) || !empty(old($favorite_store_ids)) ? (in_array($store->id, old('favorite_store_ids', $favorite_store_ids)) ? 'selected' : '') : 'selected'}}
                                                                            >{{ $store->name}}</option>
                                                                    @endforeach
                                                                </select>
                                                                    ...
                                                                    <select class="multi-select" id="favorite_category" name="favorite_category_ids[]" multiple>
                                                                        @foreach($favoriteCategory as $category)
                                                                            <option value="{{ $category->id}}" {{ old('favorite_category_ids') == $category->id  ? 'selected' : ''}}
                                                                                {{ !empty(old('favorite_category_ids')) || !empty(old($favorite_category_ids)) ? (in_array($category->id, old('favorite_category_ids', $favorite_category_ids)) ? 'selected' : '') : 'selected'}}
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-row">
                                                                    <div class="col-6 col-md-6 mb-3">
                                                                        <input type="number" id="inputAgeMin" name="min_age" class="form-control required" placeholder="Min age" max="100" value="{{ old('min_age', $min_age) }}">
                                                                        @if($errors->has('min_age'))
                                                                            <p class="statusDanger text-danger error-msg">{{ $errors->first('min_age') }}</p>
                                                                        @endif
                                                                    </div>
                                                                    <div class="col-6 col-md-6 mb-3">
                                                                        <input type="number" id="inputAgeMax" name="max_age" class="form-control required" placeholder="Max age" max="100" value="{{ old('max_age', $max_age) }}">
                                                                ...
                                                                <div class="selectgroup selectgroup-pills">
                                                                    @if (count($CadAdvertisementCategories) > 0)
                                                                        ...
                                                                        <label class="selectgroup-item">
                                                                            ...
                                                                            class="selectgroup-input form-control" id="advCat_{{ $key }}" value="{{ $CadAdvertisementCategorie->advertisement_category_id }}" {{ !empty(old('adv_cat', $cat_ids)) ? (in_array($CadAdvertisementCategorie->advertisement_category_id, old('adv_cat', $cat_ids)) ? 'checked' : '') : ''}} onClick="fnCategoryClick(this)">
                    ...
                    <div class="form-group" id="imageSectionFeed">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-8" id="native_ads">
                                <div class="count_native_ads gradient-box p-md-2 p-sm-1" style="border: 1px solid rgba(83, 16, 240, 0.57);" id="nativeAd_{{ $key }}">

                                    <a href="javascript:void(0)" class="float-right native_remove_btn" onclick="fnRemoveNativeAd({{ $key }})" {{ count($advertisement['Native']) == 1 ? 'style=display:none' : '' }}><i class="fa fa-close"></i></a>

                                    <div class="form-group">
                                        <label class="control-label">Upload Image</label>
                                        <input type="file" class="dropify form-control" data-height="185" accept="image/*" id="native_ad_img{{ $key }}" name="nativeAdImg[{{ $native['media_id'] }}]" data-default-file="{{ asset($native['media_link']) }}" onchange="validateNative({{ $key }})" />
                                    ...
                                    <div class="form-row">
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <select class="form-control nativeAdType native_ad_type required" name="native_ad_type[{{ $native['media_id'] }}]" id="native_ad_type{{ $key }}" required onchange="percentCheckByAdTypeNative({{ $key }}, this.value);validateNative({{ $key }});">
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="nativeAdRefLink{{ $key }}" name="nativeAdRefLink[{{ $native['media_id'] }}]" placeholder="Enter Referal Link" class="form-control required" value="{{ $native['referal_link'] }}" onblur="validateNative({{ $key }});">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" id="nativeAdPercent{{ $key }}" name="nativeAdPercent[{{ $native['media_id'] }}]" placeholder="Enter time percent" class="form-control required inputAdvFeedShowTime nativeAdPercent" min="1" value="{{ $native['time_percent'] }}"
                                                onkeyup="nativeAdPercentCalculation(this, {{ $key }});validateNative({{ $key }});" required>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="number" id="adv_position_slot{{ $key }}" name="nativeAdPosition[{{ $native['media_id'] }}]" class="form-control nativeAdPosition required" min="1" placeholder="Ad position" value="{{ $native['position'] }}" onkeyup="validateNative({{ $key }})" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        @elseif (!empty(old('native_ad_type')))
                        <div class="row">
                                    ...
                                    <div class="form-row">
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                <label class="control-label">Ad Type</label>
                                                <div class="controls">
                                                    <select class="form-control nativeAdType native_ad_type required" name="native_ad_type[]" id="native_ad_type{{ $i }}" onchange="percentCheckByAdTypeNative({{ $i }}, this.value);validateNative({{ $i }});">
                                                        <option value="">Select Type</option>
                                                        <option value="1" {{ old('native_ad_type')[$i] == 1 }}>Promotions</option>
                                                        <option value="2" {{ old('native_ad_type')[$i] == 2 }}>Bons Plans</option>
                                                        <option value="3" {{ old('native_ad_type')[$i] == 3 }}>Codes Promo</option>
                                                    </select>
                                                </div>
                                                @if($errors->has('native_ad_type'))
                                                    <p class="statusDanger text-danger error-msg">{{ $errors->first('native_ad_type') }}</p>
                    ...
                    <div class="form-group" id="imageSectionStory">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-8" id="story_ads">
                                ...
                                <div class="count_story_ads p-md-2 p-sm-1" style="border: 1px solid rgba(83, 16, 240, 0.57)" id="storyBlock_{{ $key }}">

                                    <a href="javascript:void(0)" class="story_remove_btn float-right" onclick="fnRemoveStory({{ $key }})" {{ count($advertisement['Story']) == 1 ? 'style=display:none' : '' }}><i class="fa fa-close"></i></a>

                                    <div class="form-group">
                                        <label class="control-label">Upload Image/Video</label>
                                        <input type="file" class="dropify form-control" data-height="185" accept="image/*" data-default-file="{{ asset($story['media_link']) }}" id="story_ad_img{{ $key }}" name="storyAdMedia[{{ $story['media_id'] }}]"
                                        onchange="validateStory({{ $key }})" />
                                    ...
                                    <div class="form-group">
                                        <label for="">Reference Url</label>
                                        <input type="text" id="storyLinkId{{ $key }}" name="storyAdRefLink[{{ $story['media_id'] }}]" placeholder="Enter Referal Link" class="form-control required" value="{{ $story['referal_link'] }}" onkeyup="validateStory({{ $key }})">
                                    </div>
                                </div>
                            </div>
                            @endforeach
                        ...
                        @elseif (!empty(old('storyAdRefLink')))
                        <div class="row">
                    ...
                    <div class="form-group" id="imageSectionStory">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-8" id="banner_ads">
                                <div class="count_banner_ads p-md-2 p-sm-1" style="border: 1px solid rgba(83, 16, 240, 0.57)" id="bannerBlock_{{ $key }}">

                                    <a href="javascript:void(0)" class="banner_remove_btn float-right" onclick="fnRemoveBanner({{ $key }})" {{ count($advertisement['Banner']) == 1 ? 'style=display:none' : '' }}><i class="fa fa-close"></i></a>

                                    <div class="form-group">
                                        <label class="control-label">Upload Image</label>
                                        <input type="file" class="dropify banner_ad_img" data-height="185" accept="image/*" data-default-file="{{ asset($banner['media_link']) }}" value="{{ $banner['media_link'] }}" id="banner_ad_img{{ $key }}" name="bannerAdImg[{{ $banner['media_id'] }}]"
                                        onchange="validateBanner({{ $key }})" />
                                    ...
                                    <div class="form-group">
                                        <label for="">Reference Url</label>
                                        <input type="text" id="bannerAdRefLink{{ $key }}" name="bannerAdRefLink[{{ $banner['media_id'] }}]" placeholder="Enter Referal Link" class="form-control required" value="{{ $banner['referal_link'] }}" onblur="validateBanner({{ $key }})">
                                    </div>
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label">Ad Type</label>
                                                <div class="controls">
                                                    <select class="form-control bannerAdType banner_ad_type" name="banner_ad_type[{{ $banner['media_id'] }}]" id="banner_ad_type{{ $key }}" onchange="percentCheckByAdType({{ $key }}, this.value);validateBanner({{ $key }});">
                                                        <option value="">Select Type</option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="">Percent</label>
                                                <input type="number" id="bannerAdPercent{{ $key }}" name="bannerAdPercent[{{ $banner['media_id'] }}]" placeholder="Enter time percent" class="form-control bannerAdPercent required" min="1" value="{{ $banner['time_percent'] }}" onkeyup="bannerAdPercentCalculation(this, {{ $key }});validateBanner({{ $key }});">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        @elseif (!empty(old('banner_ad_type')))
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-8" id="homeBanner_ads">
                                ...
                                <div class="count_homeBanner_ads p-md-2 p-sm-1" style="border: 1px solid rgba(83, 16, 240, 0.57)" id="homeBannerBlock_0">
                                    ...
                                    <a href="javascript:void(0)" class="home_banner_remove_btn float-right" onclick="fnRemoveHomeBanner({{ $key }})" {{ count($advertisement['Home Banner']) == 1 ? 'style=display:none' : '' }}><i class="fa fa-close"></i></a>

                                    <div class="form-group">
                                        <label class="control-label">Upload Image</label>
                                        <input type="file" class="dropify form-control" data-height="185" accept="image/*" id="home_banner_img{{ $key }}" name="homeBannerMedia[{{ $banner['media_id'] }}]" data-default-file="{{ asset($banner['media_link']) }}" value="{{ $banner['media_link'] }}" onchange="validateHomeBanner({{ $key }})" />
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <div class="form-group">
                                                    <label for="">Reference Url</label>
                                                    <input type="text" id="homeBannerRefLinkId{{ $key }}" name="homeBannerRefLink[{{ $banner['media_id'] }}]" placeholder="Enter Referal Link" class="form-control required" value="{{ $banner['referal_link'] }}" onblur="validateHomeBanner({{ $key }})">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label">Position</label>
                                                <input type="number" id="homeBannerAdPosition{{ $key }}" name="homeBannerAdPosition[{{ $banner['media_id'] }}]" class="form-control homeBannerAdPosition required" min="1" placeholder="Ad position" value="{{ $banner['position'] }}" onkeyup="validateHomeBanner({{ $key }})">
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            @if (isset($advertisement['Native']))
                automaticallyPreviewNativeAds("{{ count($advertisement['Native']) }}");
            @endif

            @if (isset($advertisement['Story']))
                automaticallyPreviewStoryAds("{{ count($advertisement['Story']) }}");
            @endif


            @if (isset($advertisement['Banner']))
                automaticallyPreviewBannerAds("{{ count($advertisement['Banner']) }}");
            @endif

            @if (isset($advertisement['Home Banner']))
                automaticallyPreviewHomeBannerAds("{{ count($advertisement['Home Banner']) }}");
            @endif

        });

        @if (!empty(old('adv_cat', $cat_ids)))
            @foreach (old('adv_cat', $cat_ids) as $cat)
                fnCategoryShow({{ $cat }});
            @endforeach
        @endif
